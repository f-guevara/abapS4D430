CLASS zcl_fg100_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
**********************************************************************
*    TYPES zfg100t_addresses TYPE SORTED TABLE OF /lrn/s_address
...
CLASS ZCL_FG100_TABLE_TYPE IMPLEMENTATION.
...
* Task 1
**********************************************************************
    DATA addresses TYPE zfg100t_addresses.
...
* Task 2
**********************************************************************
    DATA person TYPE zfg100s_person_deep.
...
* Task 3
**********************************************************************
    DATA persons TYPE zfg100t_persons.
